...
if (IS_DIRECTORY "${EXPECTED_OUTPUT}")
    ...
    foreach(_file ${expected_files})
        ...
        set(NDIFF_COMPARISON_${_NDIFF_COUNT} COMMAND ${NDIFF_EXECUTABLE} -abserr ${TEST_ABS_TOLERANCE} -relerr ${TEST_REL_TOLERANCE} ${_file} ${TEST_OUTPUT}/${_output_file})
    endforeach()
elseif (EXISTS "${EXPECTED_OUTPUT}")
    set(_NDIFF_COUNT 1)
    set(NDIFF_COMPARISON_1 COMMAND ${NDIFF_EXECUTABLE} -abserr ${TEST_ABS_TOLERANCE} -relerr ${TEST_REL_TOLERANCE} ${EXPECTED_OUTPUT} ${TEST_OUTPUT})
endif ()
