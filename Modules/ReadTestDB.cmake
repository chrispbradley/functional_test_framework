...
macro(add_functional_test TEST_DESCRIPTION_FILE)
    ...
    foreach(_prefix TEST_ PYTEST_)
        ...
        if (DEFINED TEST_MULTI_PROCESS)
            set(TEST_${TEST_COUNT}_MULTI_PROCESS ${TEST_MULTI_PROCESS})
            set(TEST_${TEST_COUNT}_NP ${TEST_NP})
        else ()
            set(TEST_${TEST_COUNT}_MULTI_PROCESS FALSE)
        endif ()
    endforeach()
endmacro()
